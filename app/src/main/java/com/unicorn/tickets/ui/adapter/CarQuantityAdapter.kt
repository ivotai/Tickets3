...
import kotlinx.android.synthetic.main.item_car_quantitiy.*

class CarQuantityAdapter : BaseQuickAdapter<CarQuantity, KVHolder>(R.layout.item_car_quantitiy) {

    override fun convert(helper: KVHolder, item: CarQuantity) {
        helper.apply {
